      ...
      <div className="bluepointContenerArticles">
        ...
        <div className="bluepointSatisfactionMain bluepointAnimD bluepointArticleMain">
          <div className="bluepointSatisfactionLeft">
            ...
            <div className="bluepointContnerImgAndBlueCarré">
              <div className="bluepointContnerImgSatisfaction">
                <Image
                  className="bluepointImgSatisfaction"
                  loading="lazy"
                  width={1000}
                  height={570}
                  alt="ImgSatisfaction"
                  src={
                    "https://drive.google.com/uc?id=17lbQJF-4EQfZC30dNuP8Sf5mQr4KQQmw"
                  }
                />
              </div>
            </div>
          ...
          <div className="bluepointContenertext">
            ...
            <span className="bluepointSiteSubtitle bluepointArticleText">
              Notre objectif est de bâtir une relation commerciale pérenne avec
              vous et de devenir votre partenaire numérique local de confiance.
            </span>
            <span className="bluepointSiteSubtitle bluepointArticleText">
              Afin de maintenir des standards élevés de qualité et de service,
              nous vous envoyons une enquête de satisfaction à la fin de chaque
              mission.
            </span>
          </div>
        </div>
        ...
        <div className="bluepointPersonaMain bluepointAnimG bluepointArticleMain">
          <div className="bluepointPersonaRight">
            ...
            <div className="bluepointContnerImgAndBlueCarré">
              <div className="bluepointContnerImgSatisfaction">
                <Image
                  className="bluepointImgPersonalisation"
                  loading="lazy"
                  width={7356}
                  height={3678}
                  alt="ImgPersonalisation"
                  src={
                    "https://drive.google.com/uc?id=1AfJ6XB4VzIdhAyyYljqKba39GiS8A_72"
                  }
                />
              </div>
            </div>
          ...
          <div className="bluepointContenertext">
            ...
            <span className="bluepointPersonaArticle bluepointArticleText">
              ...
              ancrée dans nos valeurs fondamentales. Nous écoutons vos besoins,
              pour comprendre les défis de votre marché et surtout, appliquer
              vos choix et vos attentes.
            </span>
            {/* *******3eme paragraphe******* */}
            <span className="bluepointPersonaArticle bluepointArticleText">
              {/* plusieurs languages */}
        ...
        <div className="bluepointSavMain bluepointAnimD bluepointArticleMain">
            ...
            <div className="bluepointContnerImgAndBlueCarré">
              <div className="bluepointContnerImgSatisfaction">
                <Image
                  ...
                  alt="ImgSatisfaction"
                  src={
                    "https://drive.google.com/uc?id=1kx5O4nXr8rAl92qQ2SZFytdhG0ZzvPVS"
                  }
                />
              </div>
            </div>
          ...
          <div className="bluepointContenertext">
            ...
            <span className="bluepointSavSubtitle bluepointArticleText">
              Que vous ayez des questions sur le fonctionnement de votre outil,
              besoin d&apos;aide pour utiliser une fonctionnalité spécifique, ou
              que vous rencontriez des défis techniques, nous sommes là pour
              vous soutenir.
            </span>
            <span className="bluepointSavSubtitle bluepointArticleText">
              Notre objectif principal est de bâtir une relation professionnelle
              solide et durable avec vous. Nous aspirons à devenir votre
              partenaire technique de confiance, toujours là pour vous
