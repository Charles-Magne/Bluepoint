      ...
      <div className="contenerMainDetailService">
        ...
        <div className="DetailServiceIconeAndTexte" >
          ...
          <div className="DetailServiceTextDev">
            Experts dans le developpement web
          </div>
        </div>
        <div className="DetailServiceIconeAndTexte" >
          <FontAwesomeIcon
        ...
        <div className="DetailServiceIconeAndTexte" >
          <FontAwesomeIcon
            ...
            icon={faSliders}
          />
          <div className="DetailServiceTextDev">Des offres personalisées</div>
        </div>
        <div className="DetailServiceIconeAndTexte" >
        ...
        <div className="DetailServiceIconeAndTexte" >
          ...
          <div className="DetailServiceTextDev"> Solutions securisés</div>
        </div>
        <div className="DetailServiceIconeAndTexte" >
          <FontAwesomeIcon
            className="DetailServiceIconeSuper"
        ...
        <div className="DetailServiceIconeAndTexte" >
          ...
          <div className="DetailServiceTextDev">Passionés</div>
        </div>
